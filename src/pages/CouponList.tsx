  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="space-y-4">
        ...
        {isTypeFilterOpen && (
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm animate-in slide-in-from-top-2 duration-300 flex flex-wrap items-center gap-3">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-visible shadow-sm shadow-slate-100/50 min-h-[400px]">
              ...
              {filteredCoupons.map((coupon) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() => onNavigate('coupon-edit', { id: coupon.id })}
                  >
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center border shadow-sm ${coupon.type === 'cash' ? 'bg-green-50 border-green-100' :
                    ...
                    <td className="px-8 py-6">
                      <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border ${getStatusStyles(coupon.status)}`}>
                        <span className={`w-1.5 h-1.5 rounded-full ${coupon.status === 'Live' ? 'bg-green-500 animate-pulse' :
