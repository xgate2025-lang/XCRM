...
export class MockCouponService {
  ...
  private static INITIAL_COUPONS: Coupon[] = [
    ...
    },
    {
      ...
      totalQuota: 1000,
      userQuota: 1,
      personalQuota: { maxCount: 1, timeWindow: 'month', windowValue: 1 },
      validityType: 'fixed',
    ...
    },
    {
      ...
      totalQuota: 500,
      userQuota: 1,
      personalQuota: { maxCount: 1, timeWindow: 'week', windowValue: 2 },
      validityType: 'dynamic',
      validityMode: 'dynamic',
      validityDelay: 7,
      validityDays: 14,
